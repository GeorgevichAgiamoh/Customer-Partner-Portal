...
import { adminUserEle, defVal, fileEle, getCreatedTime, msgEle, msgThread, partnerBasicinfo, partnerFinancialinfo, partnerGeneralinfo, schoolBasicinfo, schoolGeneralinfo, schoolPropInfo } from "../../../classes/models"
...
export function SchoolMessageThread(mainprop:{thread:msgThread,sbi:schoolBasicinfo,backy:(action:number)=>void}){
