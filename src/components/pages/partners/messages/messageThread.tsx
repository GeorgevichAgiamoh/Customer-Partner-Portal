...
import { adminUserEle, defVal, fileEle, getCreatedTime, msgEle, msgThread, partnerBasicinfo, partnerFinancialinfo, partnerGeneralinfo } from "../../../classes/models"
...
export function PartnerMessageThread(mainprop:{thread:msgThread,pbi:partnerBasicinfo,backy:(action:number)=>void}){
