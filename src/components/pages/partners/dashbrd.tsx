...
import { myEles, setTitle, appName, Mgin, LrText, BtnIcn, icony, IconBtn, ErrorCont, MyPieChart, hexToRgba, masterID, goUrl } from "../../../helper/general";
    ...
    function Tab1(prop:{title:string, value:string, icon?:icony, color:string, isLink?:boolean}) {
        ...
        return <div id="lshdw" style={{
            ...
            <div style={{
                ...
                <Mgin top={10}/>
                {prop.isLink?<mye.Tv text={prop.value} size={12} onClick={()=>{
                    goUrl(prop.value)
